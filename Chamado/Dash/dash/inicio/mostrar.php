...
<body class="">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Telefone Clínica</th>
      <th scope="col">Data de nascimento</th>
      <th scope="col"> <a href="./usuario.php"><button type="submit" class="btn btn-fill btn-primary">Cadastrar Usuário</button></a></th>
    </tr>
  </thead>
  <tbody>
     ...
     <td><?php echo $dado['CodLogin']; ?></td>
   
     <td><?php echo $dado['Clinica']; ?></td>
   
     <td><?php echo $dado['TelClin']; ?></td>
